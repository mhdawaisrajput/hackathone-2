  ...
  return (
    ...
    >
      <div className="relative">
        <h1
          className="absolute w-[108px] h-[28px] top-[2261px] left-[24px] text-[24px] leading-[36px] 
        ...
        <p
          className="absolute w-[216px] top-[2312px] left-[24px] text-[12px] tracking-[-0.01em]
      ...
      <div className="relative">
        <h1
          className="absolute w-[142px] top-[2401px] left-[24px]
        ...
        <ul>
          <li>
            <Link
              href={""}
              className="absolute w-[142px] h-[144px] left-[24px] top-[2453px] text-[#90A3BF]
            ...
            <Link
              href={""}
              className="absolute w-[142px] h-[144px] left-[24px] top-[2492px] text-[#90A3BF]
            ...
            <Link
              href={""}
              className="absolute w-[142px] h-[144px] left-[24px] top-[2531px] text-[#90A3BF]
            ...
            <Link
              href={""}
              className="absolute w-[142px] h-[144px] left-[24px] top-[2570px] text-[#90A3BF] 
      ...
      <div className="relative">
        <h1
          className="absolute w-[142px] top-[2401px] left-[231px]
        ...
        <ul>
          <li>
            <Link
              href={""}
              className="absolute w-[120px] h-[144px] left-[231px] top-[2453px] text-[#90A3BF]
            ...
            <Link
              href={""}
              className="absolute w-[120px] h-[144px] left-[231px] top-[2492px] text-[#90A3BF]
            ...
            <Link
              href={""}
              className="absolute w-[120px] h-[144px] left-[231px] top-[2531px] text-[#90A3BF]
            ...
            <Link
              href={""}
              className="absolute w-[120px] h-[144px] left-[231px] top-[2570px] text-[#90A3BF]
      ...
      <div className="relative">
        <h1
          className="absolute w-[142px] top-[2641px] left-[24px]
        ...
        <ul>
          <li>
            <Link
              href={""}
              className="absolute w-[120px] h-[144px] left-[24px] top-[2693px] text-[#90A3BF]
            ...
            <Link
              href={""}
              className="absolute w-[120px] h-[144px] left-[24px] top-[2732px] text-[#90A3BF]
            ...
            <Link
              href={""}
              className="absolute w-[120px] h-[144px] left-[24px] top-[2771px] text-[#90A3BF]
            ...
            <Link
              href={""}
              className="absolute w-[120px] h-[144px] left-[24px] top-[2810px] text-[#90A3BF]
      ...
      <div className="relative">
        <h2
          className="absolute w-[200px] h-[16px] top-[2929px] left-[24px]
        ...
        <h2
          className="absolute w-[92px] h-[16px] top-[2881px] left-[24px]
        ...
        <h2
          className="absolute w-[104px] h-[16px] top-[2881px] left-[247px]
